...
G: Grupo (número de grupo)

H: Lista de horarios (cada uno como string, ejemplo: "S 13:00-16:50", "L, J 08:00-11:50")

M: Modalidad (por ejemplo, "VIRTUAL", "PRESENCIAL", "BIMODAL", "BAJO VIRTUAL")

A: Aula y edificio si aparece (por ejemplo, "N-03 N")

R: Requisitos (como lista de siglas, por ejemplo ["TM8500"]) si aparecen

CO: Correquisitos (como lista de siglas, por ejemplo ["TM8100", "TM1300"]) si aparecen
...
[
 {
  ...
  {
    "SG": "TM4100",
    "N": "DESARROLLO DE APLICACIONES INTERACTIVAS I",
    "T": 7,
    "C": 4,
    "P": 2,
    "G": "002",
    "H": ["K 13:00-16:50", "V 13:00-16:50"],
    "M": "BAJO VIRTUAL",
    "A": "N-03 N"
  }
]
