...
function RouteComponent() {
  return <div className='h-screen bg-gray-100 text-gray-800 flex items-center justify-center'>
...
<div className="bg-blue-900 text-white rounded-3xl p-8 flex flex-col items-center justify-center h-full min-h-[400px]">
  <div className="w-32 h-32 bg-white rounded-full flex items-center justify-center mb-4">
    <img src="ruta/avatar.png" alt="Avatar" className="w-28 h-28 object-cover rounded-full"/>
  </div>
  <div className="flex items-center gap-2">
    <span className="bg-blue-600 py-2 px-4 rounded-md font-semibold">Nombre Usuario</span>
    ...
    <div className="bg-white rounded-xl shadow-lg p-8">
      ...
      <div className="mt-8 flex justify-end">
        <div className="flex items-center bg-blue-200 rounded-full w-24 p-1">
          <button className="bg-blue-900 text-white w-1/2 rounded-full py-1">🌞</button>
